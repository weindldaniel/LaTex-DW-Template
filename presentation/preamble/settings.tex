...
% Farben
% -----------------------------------------------
\definecolor{fillaccent}{RGB}{178, 11, 16}    % #b20b10 (Rot)
\definecolor{fillgray}{RGB}{120, 120, 120}   % #787878 (Grau)
\definecolor{fillblue}{RGB}{69, 73, 78}      % #45494e (Dunkelgrau/Blau)
\definecolor{filllight}{RGB}{240, 240, 240}  % neutrales hellgrau (optional angepasst)
...
\usepackage{booktabs}
\usepackage{graphicx}
\graphicspath{{/Users/danielweindl/_source/Repositorys/Bsc-Expose/shared/images}}   % Standardpfad für Grafiken
% -----------------------------------------------
% Hilfsbefehle
% -----------------------------------------------
